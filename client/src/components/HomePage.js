  ...
  render() {
    ...
    return (
       <div className="container">
        <div className="main">
          <h1 style={divStyle}> <strong>Financepeer</strong> Saidul</h1>
          <br/>
            <h5 style={divStyle}> React Machine test <span role="img" aria-label="lock"> </span><br></br>Built with React + Redux, NodeJS, Express, MongoDB and Bootstrap</h5>
