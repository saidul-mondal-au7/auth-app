    ...
    return (
       <div className="container">
        <div className="main">
          ...
          <br/>
        <Button size="lg" onClick={this.onLogout} className="btn btn-warning">Logout</Button>
        <br/>
        <br/>
        <Link className="btn btn-success" to="/upload">Upload json</Link>
        <Link className="btn btn-primary" to="/display">Display json</Link>
            </CardBody>
          </Card>
        </div>
    </div>
